...
class LaurelRecovery:
    ...
    def simulate_recovery(self, component_name):
        ...
        if component_name == "TGDKOverwatch":
            self.healthy = True  # Simulating recovery of Overwatch
        ...
        try:
            ...
            if not is_healthy:
                ...
                if component_name == "LaurelRecovery":
                    ...
                    self.recovery_system.recover_component("LaurelRecovery")
                else:
...
# Simulate a failure in Overwatch after some time
time.sleep(10)
logging.warning("Simulating TGDKOverwatch failure...")
tgdk_overwatch.healthy = False
